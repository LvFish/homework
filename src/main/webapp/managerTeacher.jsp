        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label for="edit-name" class="col-sm-2 control-label">教师名</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="edit-username" class="col-sm-2 control-label">工号</label>
                            <div class="col-sm-10">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="editTeacher()" class="btn btn-primary">
                        修改
                    </button>
                </div>
            </div><!-- /.modal-content -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label for="add-name" class="col-sm-2 control-label">教师名</label>
                            <div class="col-sm-10">
                                <input type="text"  class="form-control" id="add-name"  required="required">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="add-username" class="col-sm-2 control-label">工号</label>
                            <div class="col-sm-10">
...
<script type="text/javascript">
    ...
    $(".panel-body").on('click', 'button#delete', function () {
        ...
        var data = $("#dataTables-example").DataTable().row($(this).parents("tr")).data();
        var r=confirm("确认移除教师"+data.name+"？");
        if (r==true)
        {
            $.ajax({
                url:"/managers/deleteTeacher",
                type:"post",
                data:{
                    'userId':data.userId,
                },
