...
//        console.log(data.studentHomeworkId);
        window.location.href="/teacher/correctDetail?studentHomeworkId="+data.studentHomeworkId;
    });
    function getHomeworkDetail(homeworkId){
        $.ajax({
            url:"/teacher/getHomeworkDetail",
            type:"post",
            data:{
...
//                        var jsonObj = eval( '(' + jsonDate + ')' );
                var msg = jsonDate.homeworkDetailList;
                    ...
                    "aoColumns": [
                        ...
                        //},
                        {
                            ...
                            "render": function(data, type, row, meta) {
                                var button ="<button style='margin-right: 10px;'  id='detail' class='btn btn-primary' type='button'>得分详情</button>";
                                return button;
                            },
