        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label for="edit-name" class="col-sm-2 control-label">学生名</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="edit-username" class="col-sm-2 control-label">学号</label>
                            <div class="col-sm-10">
                                <input type="text"  class="form-control" id="edit-username"  required="required">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="edit-password" class="col-sm-2 control-label">密码</label>
                            <div class="col-sm-10">
                                <input type="text"  class="form-control" id="edit-password"  required="required">
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="editStudent()" class="btn btn-primary">
                        修改
                    </button>
                </div>
            </div><!-- /.modal-content -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label for="add-name" class="col-sm-2 control-label">学生名</label>
                            <div class="col-sm-10">
                                <input type="text"  class="form-control" id="add-name"  required="required">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="add-username" class="col-sm-2 control-label">学号</label>
                            <div class="col-sm-10">
                                <input type="text"  class="form-control" id="add-username"  required="required">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="add-password" class="col-sm-2 control-label">密码</label>
                            <div class="col-sm-10">
                                <input type="text"  class="form-control" id="add-password"  required="required">
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function addStudent(){
        ...
        if(name.length<=0||username.length<=0||password.length<=0){
            alert("请输入正确数据！");return;
        }
        $.ajax({
            url:"/managers/addStudent",
            type:"post",
            data:{
                'name':name,
                'username':username,
    ...
    $(".panel-body").on('click', 'button#delete', function () {
        ...
        var data = $("#dataTables-example").DataTable().row($(this).parents("tr")).data();
        var r=confirm("确认移除学生"+data.name+"？");
        if (r==true)
        {
            $.ajax({
                url:"/managers/deleteStudent",
                type:"post",
                data:{
                    'userId':data.userId,
                },
